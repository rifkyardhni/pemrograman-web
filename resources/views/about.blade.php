...
<head>
    ...
    <title>Peduli Kesehatan Desa | About</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-0 active" href="about">About</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="about-inner-con">
                ...
                <div class="about-txt-con">
                    <div class="generic-title" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <h2 class="mb-0">Therapy for How We Can
                            Live Better Today</h2>
                    </div>
            ...
            <div class="contact-width-box">
                <div class="contact-inner-con">
                    ...
                    <div class="contact-form ">
                        ...
                        <p data-aos="fade-up" data-aos-duration="700">Molestiae non recusandae itaque earum rerum
                            sarien.</p>
                    ...
                    <div class="item">
                        <div class="blog-box">
                            ...
                            <div class="blog-details">
                                ...
                                <h4><a href="single-blog.html">Reiciendis volutaibus
                                        maiores alias</a></h4>
                    ...
                    <div class="item">
                        <div class="blog-box">
                            ...
                            <div class="blog-details">
                                ...
                                <h4><a href="single-blog.html">Duis aute irure dolor
                    ...
                    <div class="item">
                        <div class="blog-box">
                            ...
                            <div class="blog-details">
                                ...
                                <h4><a href="single-blog.html">Riusmod tempor incidun
                                        aut labore</a></h4>
                                <p>Debitis aut rerum nec sitatoe
                                    bus saerue eveniet...</p>
                                <a href="single-blog.html">Read More <i class="fas fa-angle-right"></i></a>
