...
<head>
    ...
    <title>Peduli Kesehatan Desa | Contact</title>
    ...
    <section class="service-banner sub-banner-section w-100 float-left d-flex align-items-center">
        <div class="container">
            <div class="sub-banner-inner-con text-center">
                ...
                <p data-aos="fade-up" data-aos-duration="700">"Kami hadir untuk mendengar, membantu, menjawab, dan mewujudkan <br>
                    solusi terbaik demi langkah besar masa depan Anda."</p>
                ...
                <div class="contact-left-sec">
                    <div class="contact-detail" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="contact-txt">
                            <h4>Location:</h4>
                            <p class="mb-0">Kabupaten Sleman, Daerah Istimewa Yogyakarta, Indonesia</p>
                        </div>
                    </div>
                    <div class="contact-detail" data-aos="fade-up" data-aos-duration="700">
                        <figure class="mb-0">
                        ...
                        <div class="contact-txt">
                            <h4>Phone:</h4>
                            <a href="tel:+6212345678910">(+62 123 4567 8910)</a>
                    ...
                    <div class="contact-detail" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="contact-txt">
                            <h4>Email us at:</h4>
                            <a href="mailto:info@pkd.com">info@pkd.com</a>
                            <a href="mailto:PeduliDesa@gmail.com">PeduliDesa@gmail.com</a>
                        </div>
                    </div>
                </div>
                <div class="contact-right-sec">
                    <div class="contact-form ">
                        <span class="sub-txt d-block" data-aos="fade-up" data-aos-duration="700">Hubungi Kami</span>
                        <h2 data-aos="fade-up" data-aos-duration="700">Send us a Message</h2>
                        <p data-aos="fade-up" data-aos-duration="700">Kami Siap Melayani Anda dengan Sepenuh Hati.</p>
