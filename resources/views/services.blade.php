...
<head>
    ...
    <title>Peduli Kesehatan Desa | Layanan</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-0 active" href="services">Layanan</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="service-banner sub-banner-section w-100 float-left d-flex align-items-center">
        <div class="container">
            <div class="sub-banner-inner-con text-center">
                <h1 data-aos="fade-up" data-aos-duration="700">Tanyakan Pada Dokter!!</h1>
                <p data-aos="fade-up" data-aos-duration="700">"Percayakan kesehatan Anda kepada dokter berpengalaman. Dengan pelayanan yang ramah dan solusi yang tepat, <br>
                    kami hadir untuk kesehatan Anda dan keluarga."</p>
                <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-duration="700">
                    <ol class="breadcrumb d-inline-block mb-0">
                        ...
                        <li class="breadcrumb-item active text-white d-inline-block" aria-current="page">Layanan</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="index3-service-section w-100 float-left padding-top padding-bottom">
        <div class="container">
            <div class="generic-title text-center">
                <span class="small-text" data-aos="fade-up" data-aos-duration="700">Riwayat Layanan Kami</span>
                {{-- <h2 data-aos="fade-up" data-aos-duration="700">Riwayat</h2> --}}
            </div>
            <div class="index3-service-con">
                ...
                <div class="service-type-box" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <h4>Parenting Goals</h4>
                    <p>"Jadilah Orang Tua yang Tak Hanya Mengasuh, Tapi Juga Menginspirasi!"</p>
                </div>
                <div class="service-type-box" data-aos="fade-up" data-aos-duration="700">
                    <figure>
                    ...
                    <h4>Group Therapy</h4>
                    <p>"Di Sini, Kita Semua Belajar dan Tumbuh Bersama. Ikuti Group Therapy dan Wujudkan Perubahan Bersama!"</p>
                </div>
            </div>
        </div>
    </section>
