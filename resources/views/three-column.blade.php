...
<head>
    <title>Peduli Kesehatan Desa | Artikel</title>
    ...
    <section class="service-banner sub-banner-section w-100 float-left d-flex align-items-center">
        <div class="container">
            <div class="sub-banner-inner-con text-center">
                <h1 data-aos="fade-up" data-aos-duration="700">Artikel</h1>
                <p data-aos="fade-up" data-aos-duration="700">Berita Kesehatan Terkini untuk Anda</p>
                <nav aria-label="breadcrumb" data-aos="fade-up" data-aos-duration="700">
                    <ol class="breadcrumb d-inline-block mb-0">
                        ...
                        <li class="breadcrumb-item active text-white d-inline-block" aria-current="page">Artikel</li>
                    </ol>
                </nav>
            </div>
        </div>
