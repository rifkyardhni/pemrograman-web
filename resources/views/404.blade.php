...
<head>
    ...
    <title>Peduli Kesehatan Desa | 404</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-0" href="about">Artikel</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown4">
                                ...
                                <a class="dropdown-item" href="three-column">Single Blog</a>
    ...
    <section class="service-banner sub-banner-section w-100 float-left d-flex align-items-center">
        <div class="container">
            <div class="sub-banner-inner-con text-center">
                <h1 data-aos="fade-up" data-aos-duration="700">404</h1>
            </div>
        </div>
    </section>
    <!-- BANNER SECTION END -->
    <!-- 404 section -->
    <section class="not-found-section w-100 float-left padding-top padding-bottom">
        <div class="container">
            <div class="not-found-con text-center">
                <h2 data-aos="fade-up" data-aos-duration="700">404</h2>
                <span class="d-block" data-aos="fade-up" data-aos-duration="700">Sorry Page Was Not Found</span>
